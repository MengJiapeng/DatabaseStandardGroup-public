...
| class_id | bigint(20) unsigned | YES |   | 班级编号 |
| leader | bigint(20) unsigned | YES |   | 组长编号 |
...
| gmt\_create | datetime | YES |   | 表示记录创建时间 |
| gmt\_modified | datetime | YES |   | 表示最近修改时间 |
| class_id | bigint(20) | YES |   | 班级编号 |
| seminar_id | bigint(20)| YES |   | 讨论课编号，与班级编号一起唯一确定一堂课 |
| longitude | decimal | YES |   | 经度 |
| latitude | decimal | YES |   | 纬度 |
